...
const FAQSections = () => {
    const [activeIndex, setActiveIndex] = useState(null); // Track the active collapse
        ...
        <div className="bg-[#17312F] py-[110px] -mt-[5px] relative">
            <div className="container mx-auto flex flex-col gap-10">
                <div className="text-center font-semibold">
                    <DualHeading f="Frequently Asked " s="Questions" />
                </div>
                <div className="md:w-3/4 mx-auto flex flex-col gap-5 m-5">
                    {temp.map((item, index) => (
                        <div
                            key={index}
                            className={`collapse collapse-plus bg-[#17312F] border border-[#CBFF54] text-white ${
                        ...
                        >
                            ...
                            <div className="collapse-content dt2">
                                <p>{item.ans}</p>
                            </div>
                        </div>
                    ))}
